...
class AdapterSeries(private val listaHeroi:List<HeroiModelo>):RecyclerView.Adapter<AdapterSeries.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AdapterSeries.ViewHolder {
    ...
    class ViewHolder(val binding:RecyclerlistaheroiBinding):RecyclerView.ViewHolder(binding.root){
        fun bind(heroi: HeroiModelo){
            binding.TxtViewTexto.text = heroi.serieHeroi
